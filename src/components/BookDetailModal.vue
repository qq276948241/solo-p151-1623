  ...
  <Teleport to="body">
    <Transition name="modal">
      ...
      >
        ...
        <div class="relative bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-hidden animate-float" style="animation-iteration-count: 1; animation-duration: 0.5s;">
          <button
            class="absolute top-4 right-4 z-10 w-10 h-10 rounded-full bg-white/90 flex items-center justify-center text-primary-600 hover:bg-primary-600 hover:text-white transition-all duration-300 shadow-md"
            @click="handleClose"
          >
            <X class="w-5 h-5" />
          </button>
          ...
          <div class="flex flex-col md:flex-row">
            <div class="md:w-2/5 relative">
              <div class="aspect-[3/4] bg-cream-200">
                <img
                  :src="book.cover"
                  :alt="book.title"
            ...
            <div class="md:w-3/5 p-6 md:p-8 overflow-y-auto max-h-[60vh] md:max-h-[90vh]">
              <h2 class="text-2xl font-serif font-bold text-primary-800 mb-2">
                {{ book.title }}
              </h2>
              
              <div class="flex items-center space-x-2 text-primary-500 mb-4">
                <User class="w-4 h-4" />
              ...
              <div class="flex items-center space-x-6 text-sm text-primary-600 mb-6 py-3 px-4 bg-cream-100 rounded-xl">
              ...
              <div class="mb-6">
                <h3 class="font-serif font-semibold text-primary-700 mb-2 flex items-center">
              ...
              <p v-if="isReserved" class="text-center text-sm text-primary-500 mt-3">
                请在3天内到图书角取书
              </p>
            </div>
          </div>
